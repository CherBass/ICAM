...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--dataroot', type=str, default='./datasets',
                                 help='dataroot'
                                      './datasets'
                                      '/data/biobank/MNI_aligned_preprocessed')
        ...
        self.parser.add_argument('--image_size', type=int,  default=128,
                                 help='the height / width of the input image to network- 2D data')

        # biobank related
        self.parser.add_argument('--label_path', type=str, default='/data/biobank/biobank_labels_filtered.pkl',
                                 help='path of data')
        self.parser.add_argument('--aug_rician_noise', type=int, default=0, help='0, ([0, 10])')
        self.parser.add_argument('--aug_bspline_deformation', type=float, default=0, help='0, ([5],[0, 2])')
        self.parser.add_argument('--age_range_0', type=int, default=(40,65), help='(40,60)')
        self.parser.add_argument('--age_range_1', type=int, default=(65,90), help='(70,90)')
        self.parser.add_argument('--resize_size', type=int, default=(128, 160, 128),
                                 help='resized image size for training 3d')
        self.parser.add_argument('--resize_image', type=int, default=1, help='resized image size for training 3d')
        self.parser.add_argument('--get_id', type=bool, default=False)
        ...
        self.parser.add_argument('--tch', type=int, default=16, help='# dimensions of attribute latent space- 16-64')
        ...
        self.parser.add_argument('--nz', type=int, default=64,
                                 help='# dimensions of attribute latent space- 64 (8x8) or 640 (8x10x8)')
        self.parser.add_argument('--nz_content', type=int, default=32, help='# dimensions of content latent space- 32')
        ...
        self.parser.add_argument('--opt_weight_decay', type=float, default=0.0001, help='learning rate')
        ...
        self.parser.add_argument('--val_batch_size', type=int, default=2, help='batch size')
        ...
        self.parser.add_argument('--loss_diff_M', type=bool, default=True, help='attribution map loss')
